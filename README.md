...
[this behavior can be disabled](https://github.com/diogo-rossi/clig/blob/main/docs/sphinx/source/notebooks/advancedfeatures.md).
...
[without a function](https://github.com/diogo-rossi/clig/blob/main/docs/sphinx/source/notebooks/advancedfeatures.md#calling-cligcommand-without-a-function)
(i.e., `cmd = Command()`)
...
[unless you pass an argument to the decorators](https://github.com/diogo-rossi/clig/blob/main/docs/sphinx/source/notebooks/advancedfeatures.md#method-decorator-with-argument).
...
[pass arguments to the functions](https://github.com/diogo-rossi/clig/blob/main/docs/sphinx/source/notebooks/advancedfeatures.md#method-decorator-with-argument),
in a similar way as
[passing an argument to the methods decorators](https://github.com/diogo-rossi/clig/blob/main/docs/sphinx/source/notebooks/advancedfeatures.md#function-decorator-with-argument),
