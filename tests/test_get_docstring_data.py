...
def test_only_description_and_epilog_docstring():
    ...
    data = clig.Command(foo, docstring_template=clig.DESCRIPTION_EPILOG_DOCSTRING).get_docstring_data()
    assert data is not None
...
def test_numpy_docstring_multiline_parameters():
    ...
    data = clig.Command(foo).get_docstring_data(clig.NUMPY_DOCSTRING)
    assert data is not None
...
def test_sphinx_docstring_multiline_parameters():
    ...
    data = clig.Command(foo).get_docstring_data(clig.SPHINX_DOCSTRING)
    assert data is not None
...
def test_goole_docstring_multiline_parameters():
    ...
    data = clig.Command(foo).get_docstring_data(clig.GOOGLE_DOCSTRING)
    assert data is not None
