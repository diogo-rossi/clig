...
def test_only_description_and_epilog_docstring():
    ...
    data = clig.Command(
        foo, docstring_template=clig.DESCRIPTION_EPILOG_DOCSTRING
    ).get_inferred_docstring_data()
    assert data is not None
...
def test_numpy_docstring():
    ...
    data = clig.Command(foo, docstring_template=clig.NUMPY_DOCSTRING).get_inferred_docstring_data()
    assert data is not None
...
def test_sphinx_example():
    ...
    data = clig.Command(foo, docstring_template=clig.SPHINX_DOCSTRING).get_inferred_docstring_data()
    assert data is not None
...
def test_google_docstring():
    ...
    data = clig.Command(foo, docstring_template=clig.GOOGLE_DOCSTRING).get_inferred_docstring_data()
    assert data is not None
...
def test_clig_docstring():
    ...
    data = clig.Command(foo, docstring_template=clig.CLIG_DOCSTRING).get_inferred_docstring_data()
    assert data is not None
